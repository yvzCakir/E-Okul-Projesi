...
namespace BonusProje1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_TBLNOTLAR_TBLDERSLER1;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_TBLNOTLAR_TBLDERSLER1 = this.Relations["FK_TBLNOTLAR_TBLDERSLER1"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_TBLNOTLAR_TBLDERSLER1 = new global::System.Data.DataRelation("FK_TBLNOTLAR_TBLDERSLER1", new global::System.Data.DataColumn[] {
                        this.tableTBLDERSLER.DERSIDColumn}, new global::System.Data.DataColumn[] {
                        this.tableTBLNOTLAR.DERSIDColumn}, false);
            this.Relations.Add(this.relationFK_TBLNOTLAR_TBLDERSLER1);
        }
        ...
        public partial class TBLNOTLARDataTable : global::System.Data.TypedTableBase<TBLNOTLARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TBLNOTLARRow AddTBLNOTLARRow(TBLDERSLERRow parentTBLDERSLERRowByFK_TBLNOTLAR_TBLDERSLER1, int OGRID, byte SINAV1, byte SINAV2, byte SINAV3, byte PROJE, decimal ORTALAMA, bool DURUM) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        ORTALAMA,
                        DURUM};
                if ((parentTBLDERSLERRowByFK_TBLNOTLAR_TBLDERSLER1 != null)) {
                    columnValuesArray[1] = parentTBLDERSLERRowByFK_TBLNOTLAR_TBLDERSLER1[0];
                }
        ...
        public partial class TBLDERSLERRow : global::System.Data.DataRow {
            ...
            public TBLNOTLARRow[] GetTBLNOTLARRows() {
                if ((this.Table.ChildRelations["FK_TBLNOTLAR_TBLDERSLER1"] == null)) {
                    return new TBLNOTLARRow[0];
                }
                else {
                    return ((TBLNOTLARRow[])(base.GetChildRows(this.Table.ChildRelations["FK_TBLNOTLAR_TBLDERSLER1"])));
                }
            }
        }
        ...
        public partial class TBLNOTLARRow : global::System.Data.DataRow {
            ...
            public TBLDERSLERRow TBLDERSLERRow {
                get {
                    return ((TBLDERSLERRow)(this.GetParentRow(this.Table.ParentRelations["FK_TBLNOTLAR_TBLDERSLER1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_TBLNOTLAR_TBLDERSLER1"]);
                }
            }
...
WHERE        (TBLOGRENCILER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO TBLOGRENCILER\r\n                         (OGRID=@OGRID,OGRAD, OGRSOYAD" +
                ", OGRKULUP, OGRCINSIYET)\r\nVALUES        (@OGRID,@OGRAD,@OGRSOYAD,@OGRKULUP,@OGRC" +
                "İNSİYET)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCİNSİYET", global::System.Data.SqlDbType.VarChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCINSIYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "UPDATE       TBLNOTLAR\r\nSET                DERSID = @DERSID, OGRID = @OGRID, SINA" +
                "V1 = @SINAV1, SINAV2 = @SINAV2, SINAV3 = @SINAV3, PROJE = @PROJE, ORTALAMA = @OR" +
        ...
        internal void NotGuncelle(byte v1, int v2, byte v3, byte v4, byte v5, byte v6, decimal v7, bool v8, int notid)
        {
